...
begin
	case (OPRN)
    		...
    		`ALU_OPRN_WIDTH'h02: OUT = OP1 - OP2; 	// subtract
    		`ALU_OPRN_WIDTH'h03: OUT = OP1 * OP2; 	// multiplication
    		`ALU_OPRN_WIDTH'h04: OUT = OP1 >> OP2; 	// srl
    		`ALU_OPRN_WIDTH'h05: OUT = OP1 << OP2; 	// sll
    		`ALU_OPRN_WIDTH'h06: OUT = OP1 & OP2; 	// and
    		`ALU_OPRN_WIDTH'h07: OUT = OP1 | OP2; 	// or
    		`ALU_OPRN_WIDTH'h08: OUT = ~(OP1 | OP2); 	// nor
    		`ALU_OPRN_WIDTH'h09: OUT = (OP1 < OP2) ? 32'd1 : 32'd0; // slt
